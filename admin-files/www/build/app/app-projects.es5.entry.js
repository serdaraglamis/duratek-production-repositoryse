...
App.loadBundle('app-projects', ['exports', './chunk-ac6932ea.js'], function (exports, __chunk_1) {
    var h = window.App.h;
    var appProjects = /** @class */ (function () {
        function appProjects() {
            this.isAdmin = false;
        }
        appProjects.prototype.componentWillLoad = function () {
            var _this = this;
        ...
        appProjects.prototype.componentDidUpdate = function () {
            var _this = this;
        ...
        appProjects.prototype.updateOrders = function () {
                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, asyncForEach(this.pageData, function (item) { return __awaiter(_this, void 0, void 0, function () {
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0: return [4 /*yield*/, __chunk_1.updateFromPath("datasource/projects/" + item._id, item)];
                                            case 1:
                                                _a.sent();
                                                return [2 /*return*/];
                                        }
        ...
        appProjects.prototype.deleteItem = function (id) {
            var _this = this;
            swal({
        ...
        appProjects.prototype.renderList = function () {
            var _this = this;
            return this.pageData.map(function (item, index) {
                var projectItem = item.languages[_this.currentLanguage];
                return (h("li", { class: "card-list-item", key: Date.now() + "-" + index, "data-id": item._id }, h("div", { class: "card-list-item-image" }, _this.isAdmin ? (h("div", { class: "card-list-item-overlay" }, h("button", { onClick: function () { return _this.deleteItem(item._id); }, class: "btn btn-danger btn-sm", type: "button" }, "Sil"), h("button", { onClick: function () { return _this.history.push("/projects/" + item._id); }, class: "btn btn-primary btn-sm", type: "button" }, "D\u00FCzenle"), h("button", { class: "btn btn-light btn-sm holder", type: "button" }, h("span", { class: "fix-hamburger-md" })))) : '', h("img", { width: 360, src: projectItem.image })), h("div", { class: "card-list-item-body" }, h("h3", null, index + 1, ". ", projectItem.title))));
            });
        };
        appProjects.prototype.render = function () {
            var _this = this;
            if (this.pageData) {
                return (h("div", { class: "app-events" }, h("header", { class: "page-header" }, h("div", { class: "page-header-body" }, h("div", { class: "page-header-title" }, h("h1", null, "Projeler"), h("p", null, "Her sayfada buraya bir a\u00E7\u0131klama yaz\u0131s\u0131 yazabiliriz.")), h("div", { class: "page-header-options" }, this.isAdmin ? (h("button", { onClick: function () { return _this.history.push("/add-project"); }, class: "btn btn-secondary" }, "Yeni Proje Ekle")) : ''))), h("main", { class: "page-body" }, h("ul", { class: "card-list" }, this.renderList())), h("footer", { class: "page-footer" })));
            }
        };
        Object.defineProperty(appProjects, "is", {
            get: function () { return "app-projects"; },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(appProjects, "properties", {
            get: function () {
                return {
                    "changeTrigger": {
                        "state": true
        ...
        Object.defineProperty(appProjects, "style", {
            get: function () { return ""; },
            enumerable: true,
            configurable: true
        });
