...
class appAddLocation {
    ...
    updateHandler() {
        postDataFromPath(`datasource/locations`, this.formDetail)
            .then(() => {
                            ...
                            h("form", null,
                                ...
                                h("div", { class: "section-detail-item-group" },
                                    ...
                                    h("div", { class: "form-group" },
                                        ...
                                        h("small", { class: "form-text text-muted" }, "\u00D6rn.: 40.152534 / 16.245678")),
                                    h("div", { class: "form-group" },
    ...
    static get is() { return "app-add-location"; }
...
export { appAddLocation as AppAddLocation };
