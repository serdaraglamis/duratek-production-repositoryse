...
class appEventDetail {
    ...
    componentWillLoad() {
        getFromPath(`datasource/events/${this.match.params.id}`)
            .then((resp) => {
    ...
    updateHandler() {
        updateFromPath(`datasource/events/${this.match.params.id}`, this.formDetail)
            .then(() => {
                            ...
                            h("form", null,
                                h("div", { class: "section-detail-item-group" },
                                    h("div", { class: "custom-control custom-checkbox" },
                                        ...
                                        h("label", { class: "custom-control-label" }, "Etkinli\u011Fi Yay\u0131nla"),
                                ...
                                h("div", { class: "section-detail-item-group" },
                                    h("div", { class: "form-group" },
                                        h("label", null,
                                            this.formName,
                                            " \u0130smi / Ba\u015Fl\u0131\u011F\u0131"),
                                        h("input", { value: this.formDetail.languages[this.selectedLanguage].title, onInput: (e) => this.inputHandler('title', e), type: "text", class: "form-control", id: "modalEventName", placeholder: "Etkinli\u011Fin ismi" }),
                                        h("small", { class: "form-text text-muted" },
                                            "Etkinli\u011Fin ismini yaz\u0131n\u0131z. Bu isim web sitenizde ",
                                            this.formName,
                                    ...
                                    h("div", { class: "form-group" },
                                        h("label", null,
                                            this.formName,
                                            " Lokasyonu"),
                                        h("input", { value: this.formDetail.languages[this.selectedLanguage].location, onInput: (e) => this.inputHandler('location', e), type: "text", class: "form-control", id: "modalEventLocation", placeholder: "Etkinli\u011Fin yap\u0131laca\u011F\u0131 yer" }),
                                        h("small", { class: "form-text text-muted" }, "Etkinli\u011Fin yap\u0131laca\u011F\u0131 \u015Fehir/\u00FClke bilgisi. \u00D6rn: Paris, Fransa")),
                                    h("div", { class: "form-group" },
                                        h("label", null,
                                            this.formName,
                                            " Web sitesi"),
                                        h("div", { class: "input-group" },
                                            h("div", { class: "input-group-prepend" },
                                                h("span", { class: "input-group-text", id: "modalEventWebsite-addon" }, "www.")),
                                            h("input", { value: this.formDetail.languages[this.selectedLanguage].website, onInput: (e) => this.inputHandler('website', e), type: "text", class: "form-control", id: "modalEventWebsite", "aria-describedby": "modalEventWebsite-addon", placeholder: `${this.formName}web sitesi` })),
                                        h("small", { class: "form-text text-muted" }, "Etkinli\u011Fin resmi web sitesi adresini yaz\u0131n\u0131z."))),
                                h("div", { class: "section-detail-item-group" },
                                    h("div", { class: "form-group" },
                                        h("label", null,
                                            this.formName,
    ...
    static get is() { return "app-event-detail"; }
...
export { appEventDetail as AppEventDetail };
