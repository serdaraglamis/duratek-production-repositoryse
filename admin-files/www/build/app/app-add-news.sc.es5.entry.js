...
App.loadBundle('app-add-news', ['exports', './chunk-f83566b1.js', './chunk-0d315693.js', './chunk-6be067a8.js', './chunk-aa48cfa8.js'], function (exports, __chunk_1, __chunk_2, __chunk_3, __chunk_4) {
    var h = window.App.h;
    var appAddNews = /** @class */ (function () {
        function appAddNews() {
            var _this = this;
        ...
        appAddNews.prototype.addBlock = function (type) {
            if (type === 'gallery') {
        ...
        appAddNews.prototype.addGalleryItem = function (elid) {
            var _this = this;
        ...
        appAddNews.prototype.componentWillLoad = function () {
            this.formDetail = {
                title: 'Title Here',
                isPublished: true,
                languages: {
        ...
        appAddNews.prototype.componentDidLoad = function () {
            this.initExternalLibraries();
        };
        appAddNews.prototype.componentDidUpdate = function () {
            this.initExternalLibraries();
        };
        appAddNews.prototype.changeLanguage = function (language) {
            this.selectedLanguage = language;
        };
        appAddNews.prototype.imageSelected = function (e) {
            var _this = this;
        ...
        appAddNews.prototype.initExternalLibraries = function () {
        ...
        appAddNews.prototype.initImageCropper = function () {
            var _this = this;
        ...
        appAddNews.prototype.initMediumEditor = function () {
            var _this = this;
        ...
        appAddNews.prototype.inputHandler = function (field, e) {
        ...
        appAddNews.prototype.galleryRenderer = function () {
            var _this = this;
        ...
        appAddNews.prototype.updateHandler = function () {
            var _this = this;
            __chunk_1.postDataFromPath("datasource/news", this.formDetail)
                .then(function () {
                swal('Başarılı', _this.formName + ' detayı başarıyla güncellendi!', 'success');
                _this.history.goBack();
            });
        };
        appAddNews.prototype.removeItemFromArray = function (index, e) {
            e.preventDefault();
            this.formDetail.languages[this.selectedLanguage].content.splice(index, 1);
            this.contentChanged = !this.contentChanged;
        };
        appAddNews.prototype.photoSelected = function (index, e) {
            var _this = this;
            var formData = new FormData();
        ...
        appAddNews.prototype.renderContentsBlock = function () {
            var _this = this;
        ...
        appAddNews.prototype.removeItemFromGalleryArray = function (index) {
            this.formDetail.languages[this.selectedLanguage].gallery.splice(index, 1);
            this.contentChanged = !this.contentChanged;
        };
        appAddNews.prototype.updateDetails = function () {
        ...
        appAddNews.prototype.isPublishedHandler = function (event) {
            this.formDetail.languages[this.selectedLanguage].isEnabled = event.target.checked;
        };
        appAddNews.prototype.uploadFileHandler = function (ev) {
            var _this = this;
        ...
        Object.defineProperty(appAddNews, "style", {
            get: function () { return ""; },
            enumerable: true,
            configurable: true
        });
