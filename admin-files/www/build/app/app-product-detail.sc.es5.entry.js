...
App.loadBundle('app-product-detail', ['exports', './chunk-3e396618.js', './chunk-0d315693.js', './chunk-aa48cfa8.js'], function (exports, __chunk_1, __chunk_2, __chunk_4) {
    var h = window.App.h;
    ...
    var appProductDetail = /** @class */ (function () {
        ...
        appProductDetail.prototype.componentWillLoad = function () {
            var _this = this;
            __chunk_1.getFromPath("products/" + this.match.params.id)
                .then(function (product) {
                _this.productDetail = product;
                console.log('Product Detail Calculated 3', _this.productDetail);
                _this.oldCategories = __chunk_4.cloneDeep(_this.productDetail.categories);
        ...
        appProductDetail.prototype.componentDidUpdate = function () {
            this.initExternalLibraries();
            this.initSelectors();
        };
        appProductDetail.prototype.inputChoosed = function (index, e) {
            this.productDetail.categories[index] = e.target.value;
            this.changeTrigger = !this.changeTrigger;
        };
        appProductDetail.prototype.initSelectors = function () {
            var _this = this;
        ...
        appProductDetail.prototype.getParentsName = function (id) {
            window['ssdas'] = id;
            return '';
            /*let string = '';
            ...
            console.log('Parents Name Calculated', id, string);
            return string;*/
        };
        appProductDetail.prototype.initExternalLibraries = function () {
        ...
        appProductDetail.prototype.initMediumEditor = function () {
            var _this = this;
        ...
        appProductDetail.prototype.inputHandler = function (field, e) {
        ...
        appProductDetail.prototype.renderOptions = function (it, product) {
        ...
        appProductDetail.prototype.isPublishedHandler = function (event) {
            this.productDetail.languages[this.selectedLanguage].isEnabled = event.target.checked;
        };
        appProductDetail.prototype.removeCategory = function (index, e) {
            e.preventDefault();
            this.productDetail.categories.splice(index, 1);
            this.changeTrigger = !this.changeTrigger;
        };
        appProductDetail.prototype.addCategory = function () {
            this.productDetail.categories.push('');
            this.changeTrigger = !this.changeTrigger;
        };
        appProductDetail.prototype.updateDetails = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                var newProductId_1, allcategories_1, isChanged;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!this.productDetail.categories.length) return [3 /*break*/, 7];
                            return [4 /*yield*/, __chunk_1.updateFromPath("products/" + this.match.params.id, this.productDetail)];
                        case 1:
                            _a.sent();
                            newProductId_1 = this.match.params.id;
                            allcategories_1 = __chunk_4.cloneDeep(this.productCategories);
                            isChanged = true;
                            if (!lodash_isequal(this.oldCategories, this.productDetail.categories)) return [3 /*break*/, 2];
                            isChanged = false;
                            return [3 /*break*/, 4];
                        case 2:
                            siiimpleToast.message("\u00DCr\u00FCn\u00FCn eski kategorilerle olan ili\u015Fkisi siliniyor l\u00FCtfen bekleyin...");
                            return [4 /*yield*/, asyncForEach(allcategories_1, function (item) { return __awaiter(_this, void 0, void 0, function () {
                                    var indexof;
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0:
                                                if (!(item.products.includes(newProductId_1) && this.oldCategories.includes(item._id) && !this.productDetail.categories.includes(item._id))) return [3 /*break*/, 2];
                                                indexof = item.products.indexOf(newProductId_1);
                                                item.products.splice(indexof, 1);
                                                return [4 /*yield*/, __chunk_1.updateFromPath("product-categories/" + item._id, item)];
                                            case 1:
                                                _a.sent();
                                                _a.label = 2;
                        ...
                        case 4:
                            ...
                            return [4 /*yield*/, asyncForEach(this.productDetail.categories, function (item) { return __awaiter(_this, void 0, void 0, function () {
                                    ...
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0:
                                                cateItem = allcategories_1.find(function (a) { return a._id === item; });
                                                if (!cateItem) return [3 /*break*/, 2];
                                                if (!!this.oldCategories.includes(cateItem._id)) return [3 /*break*/, 2];
                        ...
                        case 5:
                            ...
                            _a.label = 6;
                        case 6:
                            siiimpleToast.message("G\u00FCncelleme tamamlan\u0131yor. L\u00FCtfen Bekleyiniz!!!");
        ...
        appProductDetail.prototype.render = function () {
            var _this = this;
            if (this.isReady) {
        ...
        Object.defineProperty(appProductDetail, "is", {
            get: function () { return "app-product-detail"; },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(appProductDetail, "properties", {
            get: function () {
                return {
                    "changeTrigger": {
                        "state": true
        ...
        Object.defineProperty(appProductDetail, "style", {
            get: function () { return ""; },
            enumerable: true,
            configurable: true
        });
    ...
    exports.AppProductDetail = appProductDetail;
