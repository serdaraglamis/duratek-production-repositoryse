...
class appProjectDetail {
    ...
    componentWillLoad() {
        getFromPath(`datasource/projects/${this.match.params.id}`)
            .then((resp) => {
    ...
    galleryRenderer() {
        if (!this.galleryEnabled)
            return false;
        return (h("li", { class: "form-group-list-item" },
            h("label", null, "Galeri"),
            h("div", { class: "gallery-list-wrapper" },
                h("ul", { class: "gallery-list" },
                    ...
                    h("li", { class: "gallery-list-item empty" },
                        h("div", { class: "gallery-list-item-image" },
                            h("div", { class: "gallery-list-item-options" },
                                h("a", { class: "btn btn-sm btn-primary add", onClick: this.addGalleryItem.bind(this), title: "", "data-toggle": "tooltip" }, "Foto\u011Fraf Y\u00FCkle"),
                                h("a", { class: "btn btn-sm btn-light holder", href: "javascript:void(0)", title: "S\u0131ras\u0131n\u0131 De\u011Fi\u015Ftir", "data-toggle": "tooltip" },
                                    h("span", { class: "fix-hamburger-md" }))),
                        ...
                        h("div", { class: "custom-file-input gallery-list-item-file-selector" },
                            h("input", { id: "galleryFileSelector", type: "file", name: "image", class: "custom-file-input" })))))));
    }
    updateHandler() {
        updateFromPath(`datasource/projects/${this.match.params.id}`, this.formDetail)
            .then(() => {
                            ...
                            h("form", null,
                                h("div", { class: "section-detail-item-group" },
                                    h("div", { class: "custom-control custom-checkbox" },
                                        ...
                                        h("label", { class: "custom-control-label" }, "Projeyi Yay\u0131nla"),
                                ...
                                h("div", { class: "section-detail-item-group" },
                                    h("div", { class: "form-group" },
                                        h("label", null,
                                            this.formName,
                                            " \u0130smi / Ba\u015Fl\u0131\u011F\u0131"),
                                        h("input", { value: this.formDetail.languages[this.selectedLanguage].title, onInput: (e) => this.inputHandler('title', e), type: "text", class: "form-control", id: "modalEventName", placeholder: "Proje ismini yaz\u0131n\u0131z..." }),
                                        h("small", { class: "form-text text-muted" },
                                            this.formName,
                                    ...
                                    h("div", { class: "row" },
                                        h("div", { class: "form-group col-6" },
                                            h("label", null, "Proje Tarihi"),
                                            h("div", { class: "input-group" },
                                                h("input", { onInput: (e) => this.inputHandler('detailStartDate', e), type: "date", value: this.formDetail.languages[this.selectedLanguage]['detailStartDate'], class: "form-control fp-year", id: "projectStartDate", placeholder: "Ba\u015Flang\u0131\u00E7" }),
                                                h("input", { onInput: (e) => this.inputHandler('detailEndDate', e), type: "date", value: this.formDetail.languages[this.selectedLanguage]['detailEndDate'], class: "form-control fp-year", id: "projectEndDate", placeholder: "Biti\u015F" })),
                                            h("small", { class: "form-text text-muted" }, "Projenin ba\u015Flang\u0131\u00E7 ve biti\u015F tarihlerini yaz\u0131n\u0131z.")),
                                        h("div", { class: "form-group col-6" },
                                            h("label", null, "\u015Eehir"),
                                            h("input", { onInput: (e) => this.inputHandler('detailCity', e), value: this.formDetail.languages[this.selectedLanguage]['detailCity'], type: "text", class: "form-control", id: "projectCity" }),
                                            h("small", { class: "form-text text-muted" }, "Projenin yap\u0131ld\u0131\u011F\u0131 \u015Fehri yaz\u0131n\u0131z.")),
                                        h("div", { class: "form-group col-6" },
                                            h("label", null, "Sekt\u00F6r"),
                                            h("input", { onInput: (e) => this.inputHandler('detailSector', e), value: this.formDetail.languages[this.selectedLanguage]['detailSector'], type: "text", class: "form-control", id: "projectSector" }),
                                            h("small", { class: "form-text text-muted" }, "Projenin hangi sekt\u00F6r i\u00E7in yap\u0131ld\u0131\u011F\u0131n\u0131 yaz\u0131n\u0131z.")),
                                        h("div", { class: "form-group col-6" },
                                            h("label", null, "\u0130\u015Fveren"),
                                            h("input", { onInput: (e) => this.inputHandler('detailHolder', e), value: this.formDetail.languages[this.selectedLanguage]['detailHolder'], type: "text", class: "form-control", id: "projectEmployer" }),
                                            h("small", { class: "form-text text-muted" }, "Projenin hangi \u015Firket i\u00E7in yap\u0131ld\u0131\u011F\u0131n\u0131 yaz\u0131n\u0131z.")))),
                                h("div", { class: "section-detail-item-group" },
                                    h("div", { class: "form-group" },
                                        h("label", null,
                                            this.formName,
    ...
    static get is() { return "app-project-detail"; }
...
export { appProjectDetail as AppProjectDetail };
