...
App.loadBundle('app-event-detail', ['exports', './chunk-3e396618.js', './chunk-0d315693.js', './chunk-a53c4158.js', './chunk-aa48cfa8.js'], function (exports, __chunk_1, __chunk_2, __chunk_3, __chunk_4) {
    var h = window.App.h;
    var appEventDetail = /** @class */ (function () {
        ...
        appEventDetail.prototype.addBlock = function (type) {
            if (type === 'gallery') {
        ...
        appEventDetail.prototype.addGalleryItem = function (elid) {
            var _this = this;
        ...
        appEventDetail.prototype.componentWillLoad = function () {
            var _this = this;
            __chunk_1.getFromPath("datasource/events/" + this.match.params.id)
                .then(function (resp) {
        ...
        appEventDetail.prototype.componentDidLoad = function () {
            this.initExternalLibraries();
        };
        appEventDetail.prototype.componentDidUpdate = function () {
            this.initExternalLibraries();
        };
        appEventDetail.prototype.changeLanguage = function (language) {
            this.selectedLanguage = language;
        };
        appEventDetail.prototype.imageSelected = function (e) {
            var _this = this;
        ...
        appEventDetail.prototype.initExternalLibraries = function () {
        ...
        appEventDetail.prototype.initImageCropper = function () {
            var _this = this;
            ...
            console.log('GELEN', this.formDetail);
        ...
        appEventDetail.prototype.initMediumEditor = function () {
            var _this = this;
        ...
        appEventDetail.prototype.inputHandler = function (field, e) {
        ...
        appEventDetail.prototype.galleryRenderer = function () {
            var _this = this;
        ...
        appEventDetail.prototype.updateHandler = function () {
            var _this = this;
            __chunk_1.updateFromPath("datasource/events/" + this.match.params.id, this.formDetail)
                .then(function () {
                swal('Başarılı', _this.formName + ' detayı başarıyla güncellendi!', 'success');
                _this.history.goBack();
            });
        };
        appEventDetail.prototype.removeItemFromArray = function (index, e) {
            e.preventDefault();
            this.formDetail.languages[this.selectedLanguage].content.splice(index, 1);
            this.contentChanged = !this.contentChanged;
        };
        appEventDetail.prototype.photoSelected = function (index, e) {
            var _this = this;
            var formData = new FormData();
        ...
        appEventDetail.prototype.renderContentsBlock = function () {
            var _this = this;
        ...
        appEventDetail.prototype.removeItemFromGalleryArray = function (index) {
            this.formDetail.languages[this.selectedLanguage].gallery.splice(index, 1);
            this.contentChanged = !this.contentChanged;
        };
        appEventDetail.prototype.updateDetails = function () {
        ...
        appEventDetail.prototype.isPublishedHandler = function (event) {
            this.formDetail.isPublished = event.target.checked;
        };
        appEventDetail.prototype.uploadFileHandler = function (ev) {
            var _this = this;
        ...
        Object.defineProperty(appEventDetail, "style", {
            get: function () { return ""; },
            enumerable: true,
            configurable: true
        });
    ...
    exports.AppEventDetail = appEventDetail;
