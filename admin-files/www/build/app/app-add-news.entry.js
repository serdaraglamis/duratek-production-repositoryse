...
class appAddNews {
    ...
    updateHandler() {
        postDataFromPath(`datasource/news`, this.formDetail)
            .then(() => {
                                ...
                                h("div", { class: "section-detail-item-group" },
                                    h("div", { class: "form-group" },
                                        h("label", null,
                                            this.formName,
                                            " \u0130smi / Ba\u015Fl\u0131\u011F\u0131"),
                                        h("input", { value: this.formDetail.languages[this.selectedLanguage].title, onInput: (e) => this.inputHandler('title', e), type: "text", class: "form-control", id: "modalEventName", placeholder: "Haber ismini yaz\u0131n\u0131z" }),
                                        h("small", { class: "form-text text-muted" },
                                            "Haberin ismini yaz\u0131n\u0131z. Bu isim web sitenizde ",
                                            this.formName,
                                    ...
                                    h("div", { class: "form-group" },
                                        ...
                                        h("small", { class: "form-text text-muted" },
                                            ...
                                            this.formName,
                                            "ismi/ba\u015Fl\u0131\u011F\u0131na g\u00F6re otomatik olu\u015Fur.")),
                                    h("div", { class: "form-group" },
                                        h("label", null,
                                            this.formName,
                                            " Tarihi"),
                                    ...
                                    h("div", { class: "form-group" },
                                        h("label", null,
                                            this.formName,
                                            " K\u0131sa A\u00E7\u0131klamas\u0131"),
                                        h("input", { value: this.formDetail.languages[this.selectedLanguage].shortDescription, onInput: (e) => this.inputHandler('shortDescription', e), type: "text", class: "form-control", id: "modalEventName", placeholder: "Etkinli\u011Fin ismi" }),
                                        h("small", { class: "form-text text-muted" },
                                            this.formName,
    ...
    static get is() { return "app-add-news"; }
...
export { appAddNews as AppAddNews };
