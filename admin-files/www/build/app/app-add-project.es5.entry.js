...
App.loadBundle('app-add-project', ['exports', './chunk-f83566b1.js', './chunk-0d315693.js', './chunk-6be067a8.js', './chunk-aa48cfa8.js'], function (exports, __chunk_1, __chunk_2, __chunk_3, __chunk_4) {
    var h = window.App.h;
    var appAddProject = /** @class */ (function () {
        function appAddProject() {
            var _this = this;
        ...
        appAddProject.prototype.addBlock = function (type) {
            if (type === 'gallery') {
        ...
        appAddProject.prototype.addGalleryItem = function () {
            var _this = this;
        ...
        appAddProject.prototype.componentWillLoad = function () {
            this.formDetail = {
                title: 'Title Here',
                isPublished: true,
                languages: {
        ...
        appAddProject.prototype.componentDidLoad = function () {
            this.initExternalLibraries();
        };
        appAddProject.prototype.componentDidUpdate = function () {
            this.initExternalLibraries();
        };
        appAddProject.prototype.changeLanguage = function (language) {
            this.selectedLanguage = language;
        };
        appAddProject.prototype.imageSelected = function (e) {
            var _this = this;
        ...
        appAddProject.prototype.initExternalLibraries = function () {
        ...
        appAddProject.prototype.initImageCropper = function () {
            var _this = this;
        ...
        appAddProject.prototype.initMediumEditor = function () {
            var _this = this;
        ...
        appAddProject.prototype.inputHandler = function (field, e) {
        ...
        appAddProject.prototype.galleryRenderer = function () {
            var _this = this;
        ...
        appAddProject.prototype.updateHandler = function () {
            var _this = this;
            __chunk_1.postDataFromPath("datasource/projects", this.formDetail)
                .then(function () {
                swal('Başarılı', _this.formName + ' detayı başarıyla güncellendi!', 'success');
                _this.history.goBack();
            });
        };
        appAddProject.prototype.removeItemFromArray = function (index, e) {
            e.preventDefault();
            this.formDetail.languages[this.selectedLanguage].content.splice(index, 1);
            this.contentChanged = !this.contentChanged;
        };
        appAddProject.prototype.photoSelected = function (index, e) {
            var _this = this;
            var formData = new FormData();
        ...
        appAddProject.prototype.renderContentsBlock = function () {
            var _this = this;
        ...
        appAddProject.prototype.removeItemFromGalleryArray = function (index) {
            this.formDetail.languages[this.selectedLanguage].gallery.splice(index, 1);
            this.contentChanged = !this.contentChanged;
        };
        appAddProject.prototype.updateDetails = function () {
        ...
        appAddProject.prototype.isPublishedHandler = function (event) {
            this.formDetail.isPublished = event.target.checked;
        };
        appAddProject.prototype.uploadFileHandler = function (ev) {
            var _this = this;
        ...
        Object.defineProperty(appAddProject, "style", {
            get: function () { return ""; },
            enumerable: true,
            configurable: true
        });
        return appAddProject;
    }());
    exports.AppAddProject = appAddProject;
