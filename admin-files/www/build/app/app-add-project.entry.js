...
import { a as postDataFromPath } from './chunk-89a24860.js';
...
class appAddProject {
    ...
    updateHandler() {
        postDataFromPath(`datasource/projects`, this.formDetail)
            .then(() => {
                                ...
                                h("div", { class: "section-detail-item-group" },
                                    h("div", { class: "form-group" },
                                        h("label", null,
                                            this.formName,
                                            " \u0130smi / Ba\u015Fl\u0131\u011F\u0131"),
                                        h("input", { value: this.formDetail.languages[this.selectedLanguage].title, onInput: (e) => this.inputHandler('title', e), type: "text", class: "form-control", id: "modalEventName", placeholder: "Projenin ismini yaz\u0131n\u0131z..." }),
                                        h("small", { class: "form-text text-muted" },
                                            "Projenin ismini yaz\u0131n\u0131z. Bu isim web sitenizde ",
                                            this.formName,
    ...
    static get is() { return "app-add-project"; }
...
export { appAddProject as AppAddProject };
