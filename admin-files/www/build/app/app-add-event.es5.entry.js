...
App.loadBundle('app-add-event', ['exports', './chunk-3e396618.js', './chunk-0d315693.js', './chunk-a53c4158.js', './chunk-aa48cfa8.js'], function (exports, __chunk_1, __chunk_2, __chunk_3, __chunk_4) {
    var h = window.App.h;
    var appAddEvent = /** @class */ (function () {
        function appAddEvent() {
            var _this = this;
        ...
        appAddEvent.prototype.addBlock = function (type) {
            if (type === 'gallery') {
        ...
        appAddEvent.prototype.addGalleryItem = function (elid) {
            var _this = this;
        ...
        appAddEvent.prototype.componentWillLoad = function () {
            this.formDetail = {
                title: 'Title Here',
                isPublished: true,
                languages: {
        ...
        appAddEvent.prototype.componentDidLoad = function () {
            this.initExternalLibraries();
        };
        appAddEvent.prototype.componentDidUpdate = function () {
            this.initExternalLibraries();
        };
        appAddEvent.prototype.changeLanguage = function (language) {
            this.selectedLanguage = language;
        };
        appAddEvent.prototype.imageSelected = function (e) {
            var _this = this;
        ...
        appAddEvent.prototype.initExternalLibraries = function () {
        ...
        appAddEvent.prototype.initImageCropper = function () {
            var _this = this;
        ...
        appAddEvent.prototype.initMediumEditor = function () {
            var _this = this;
        ...
        appAddEvent.prototype.inputHandler = function (field, e) {
        ...
        appAddEvent.prototype.galleryRenderer = function () {
            var _this = this;
        ...
        appAddEvent.prototype.updateHandler = function () {
            var _this = this;
            __chunk_1.postDataFromPath("datasource/events", this.formDetail)
                .then(function () {
                swal('Başarılı', _this.formName + ' detayı başarıyla güncellendi!', 'success');
                _this.history.goBack();
            });
        };
        appAddEvent.prototype.removeItemFromArray = function (index, e) {
            e.preventDefault();
            this.formDetail.languages[this.selectedLanguage].content.splice(index, 1);
            this.contentChanged = !this.contentChanged;
        };
        appAddEvent.prototype.photoSelected = function (index, e) {
            var _this = this;
            var formData = new FormData();
        ...
        appAddEvent.prototype.renderContentsBlock = function () {
            var _this = this;
        ...
        appAddEvent.prototype.removeItemFromGalleryArray = function (index) {
            this.formDetail.languages[this.selectedLanguage].gallery.splice(index, 1);
            this.contentChanged = !this.contentChanged;
        };
        appAddEvent.prototype.updateDetails = function () {
        ...
        appAddEvent.prototype.isPublishedHandler = function (event) {
            this.formDetail.isPublished = event.target.checked;
        };
        appAddEvent.prototype.uploadFileHandler = function (ev) {
            var _this = this;
        ...
        appAddEvent.prototype._renderForm = function () {
            var _this = this;
        ...
        appAddEvent.prototype.render = function () {
            if (this.formDetail) {
                return (h("div", { class: "app-event-detail" }, this._renderForm()));
            }
        };
        Object.defineProperty(appAddEvent, "is", {
            get: function () { return "app-add-event"; },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(appAddEvent, "properties", {
            get: function () {
                return {
                    "contentChanged": {
                        "state": true
        ...
        Object.defineProperty(appAddEvent, "style", {
            get: function () { return ""; },
            enumerable: true,
            configurable: true
        });
    ...
    exports.AppAddEvent = appAddEvent;
