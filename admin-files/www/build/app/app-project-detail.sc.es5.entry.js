...
App.loadBundle('app-project-detail', ['exports', './chunk-f83566b1.js', './chunk-0d315693.js', './chunk-a53c4158.js', './chunk-aa48cfa8.js'], function (exports, __chunk_1, __chunk_2, __chunk_3, __chunk_4) {
    var h = window.App.h;
    var appProjectDetail = /** @class */ (function () {
        function appProjectDetail() {
            var _this = this;
        ...
        appProjectDetail.prototype.addBlock = function (type) {
            if (type === 'gallery') {
        ...
        appProjectDetail.prototype.addGalleryItem = function () {
            var _this = this;
        ...
        appProjectDetail.prototype.componentWillLoad = function () {
            var _this = this;
            __chunk_1.getFromPath("datasource/projects/" + this.match.params.id)
                .then(function (resp) {
        ...
        appProjectDetail.prototype.componentDidLoad = function () {
            this.initExternalLibraries();
        };
        appProjectDetail.prototype.componentDidUpdate = function () {
            this.initExternalLibraries();
        };
        appProjectDetail.prototype.changeLanguage = function (language) {
            this.selectedLanguage = language;
        };
        appProjectDetail.prototype.imageSelected = function (e) {
            var _this = this;
        ...
        appProjectDetail.prototype.initExternalLibraries = function () {
        ...
        appProjectDetail.prototype.initImageCropper = function () {
            var _this = this;
        ...
        appProjectDetail.prototype.initMediumEditor = function () {
            var _this = this;
        ...
        appProjectDetail.prototype.inputHandler = function (field, e) {
        ...
        appProjectDetail.prototype.galleryRenderer = function () {
            var _this = this;
        ...
        appProjectDetail.prototype.updateHandler = function () {
            var _this = this;
            __chunk_1.updateFromPath("datasource/projects/" + this.match.params.id, this.formDetail)
                .then(function () {
                swal('Başarılı', _this.formName + ' detayı başarıyla güncellendi!', 'success');
                _this.history.goBack();
            });
        };
        appProjectDetail.prototype.removeItemFromArray = function (index, e) {
            e.preventDefault();
            this.formDetail.languages[this.selectedLanguage].content.splice(index, 1);
            this.contentChanged = !this.contentChanged;
        };
        appProjectDetail.prototype.photoSelected = function (index, e) {
            var _this = this;
            var formData = new FormData();
        ...
        appProjectDetail.prototype.renderContentsBlock = function () {
            var _this = this;
        ...
        appProjectDetail.prototype.removeItemFromGalleryArray = function (index) {
            this.formDetail.languages[this.selectedLanguage].gallery.splice(index, 1);
            this.contentChanged = !this.contentChanged;
        };
        appProjectDetail.prototype.updateDetails = function () {
        ...
        appProjectDetail.prototype.isPublishedHandler = function (event) {
            this.formDetail.isPublished = event.target.checked;
        };
        appProjectDetail.prototype.uploadFileHandler = function (ev) {
            var _this = this;
        ...
        Object.defineProperty(appProjectDetail, "style", {
            get: function () { return ""; },
            enumerable: true,
            configurable: true
        });
        return appProjectDetail;
    }());
    exports.AppProjectDetail = appProjectDetail;
